...
type FundVirtualPsbtRequest struct {
	...
	// An optional list of inputs to use. These inputs will be used regardless of
	// whether `psbt` or `raw` is provided. Every input must be an asset UTXO
	// known to the wallet.
	Inputs []*PrevId `protobuf:"bytes,3,rep,name=inputs,proto3" json:"inputs,omitempty"`
	// Specify the type of coins that should be selected. Defaults to allowing both
	// script trees and BIP-086 compliant inputs.
	CoinSelectType CoinSelectType `protobuf:"varint,4,opt,name=coin_select_type,json=coinSelectType,proto3,enum=assetwalletrpc.CoinSelectType" json:"coin_select_type,omitempty"`
}
...
func (x *FundVirtualPsbtRequest) GetInputs() []*PrevId {
	if x != nil {
		return x.Inputs
	}
	return nil
...
type CreateInteractiveSendTemplateRequest struct {
	...
	//
	//	*CreateInteractiveSendTemplateRequest_AssetId
	//	*CreateInteractiveSendTemplateRequest_AssetIdStr
	Asset isCreateInteractiveSendTemplateRequest_Asset `protobuf_oneof:"asset"`
	// Amount of the asset to send.
	Amount uint64 `protobuf:"varint,3,opt,name=amount,proto3" json:"amount,omitempty"`
	// Lock time (optional).
	LockTime uint64 `protobuf:"varint,4,opt,name=lock_time,json=lockTime,proto3" json:"lock_time,omitempty"`
	// Relative lock time (optional).
	RelativeLockTime uint64 `protobuf:"varint,5,opt,name=relative_lock_time,json=relativeLockTime,proto3" json:"relative_lock_time,omitempty"`
	// Output index for the anchor.
	OutputIndex uint32 `protobuf:"varint,6,opt,name=output_index,json=outputIndex,proto3" json:"output_index,omitempty"`
	// Script key for the receiving address.
	ScriptKey []byte `protobuf:"bytes,7,opt,name=script_key,json=scriptKey,proto3" json:"script_key,omitempty"`
	// Anchor internal key for the transaction.
	AnchorInternalKey []byte `protobuf:"bytes,8,opt,name=anchor_internal_key,json=anchorInternalKey,proto3" json:"anchor_internal_key,omitempty"`
}

func (x *CreateInteractiveSendTemplateRequest) Reset() {
	*x = CreateInteractiveSendTemplateRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateInteractiveSendTemplateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateInteractiveSendTemplateRequest) ProtoMessage() {}

func (x *CreateInteractiveSendTemplateRequest) ProtoReflect() protoreflect.Message {
	mi := &file_assetwalletrpc_assetwallet_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateInteractiveSendTemplateRequest.ProtoReflect.Descriptor instead.
func (*CreateInteractiveSendTemplateRequest) Descriptor() ([]byte, []int) {
	return file_assetwalletrpc_assetwallet_proto_rawDescGZIP(), []int{2}
}

func (m *CreateInteractiveSendTemplateRequest) GetAsset() isCreateInteractiveSendTemplateRequest_Asset {
	if m != nil {
		return m.Asset
	}
	return nil
...
func (x *CreateInteractiveSendTemplateRequest) GetAssetId() []byte {
	if x, ok := x.GetAsset().(*CreateInteractiveSendTemplateRequest_AssetId); ok {
		return x.AssetId
	}
	return nil
}

func (x *CreateInteractiveSendTemplateRequest) GetAssetIdStr() string {
	if x, ok := x.GetAsset().(*CreateInteractiveSendTemplateRequest_AssetIdStr); ok {
		return x.AssetIdStr
	}
	return ""
}

func (x *CreateInteractiveSendTemplateRequest) GetAmount() uint64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *CreateInteractiveSendTemplateRequest) GetLockTime() uint64 {
	if x != nil {
		return x.LockTime
	}
	return 0
...
func (x *CreateInteractiveSendTemplateRequest) GetRelativeLockTime() uint64 {
	if x != nil {
...
func (x *CreateInteractiveSendTemplateRequest) GetOutputIndex() uint32 {
	if x != nil {
...
func (x *CreateInteractiveSendTemplateRequest) GetScriptKey() []byte {
	if x != nil {
		return x.ScriptKey
	}
	return nil
...
func (x *CreateInteractiveSendTemplateRequest) GetAnchorInternalKey() []byte {
	if x != nil {
...
type isCreateInteractiveSendTemplateRequest_Asset interface {
	isCreateInteractiveSendTemplateRequest_Asset()
}

type CreateInteractiveSendTemplateRequest_AssetId struct {
	// The raw bytes of the asset ID being sent.
	AssetId []byte `protobuf:"bytes,1,opt,name=asset_id,json=assetId,proto3,oneof"`
}

type CreateInteractiveSendTemplateRequest_AssetIdStr struct {
	// The hex-encoded asset ID of the asset being sent.
	AssetIdStr string `protobuf:"bytes,2,opt,name=asset_id_str,json=assetIdStr,proto3,oneof"`
}

func (*CreateInteractiveSendTemplateRequest_AssetId) isCreateInteractiveSendTemplateRequest_Asset() {}

func (*CreateInteractiveSendTemplateRequest_AssetIdStr) isCreateInteractiveSendTemplateRequest_Asset() {
}
...
type CreateInteractiveSendTemplateResponse struct {
	...
	// The serialized virtual PSBT template.
	Psbt []byte `protobuf:"bytes,1,opt,name=psbt,proto3" json:"psbt,omitempty"`
}

func (x *CreateInteractiveSendTemplateResponse) Reset() {
	*x = CreateInteractiveSendTemplateResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateInteractiveSendTemplateResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateInteractiveSendTemplateResponse) ProtoMessage() {}

func (x *CreateInteractiveSendTemplateResponse) ProtoReflect() protoreflect.Message {
	mi := &file_assetwalletrpc_assetwallet_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateInteractiveSendTemplateResponse.ProtoReflect.Descriptor instead.
func (*CreateInteractiveSendTemplateResponse) Descriptor() ([]byte, []int) {
	return file_assetwalletrpc_assetwallet_proto_rawDescGZIP(), []int{3}
}

func (x *CreateInteractiveSendTemplateResponse) GetPsbt() []byte {
	if x != nil {
		return x.Psbt
	}
	return nil
...
type PrepareAnchoringTemplateRequest struct {
	...
	VirtualPsbt []byte `protobuf:"bytes,1,opt,name=virtual_psbt,json=virtualPsbt,proto3" json:"virtual_psbt,omitempty"`
	// The amount (in satoshis) to send to the output address.
	OutputAmt int64 `protobuf:"varint,2,opt,name=output_amt,json=outputAmt,proto3" json:"output_amt,omitempty"`
}

func (x *PrepareAnchoringTemplateRequest) Reset() {
	*x = PrepareAnchoringTemplateRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PrepareAnchoringTemplateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrepareAnchoringTemplateRequest) ProtoMessage() {}

func (x *PrepareAnchoringTemplateRequest) ProtoReflect() protoreflect.Message {
	mi := &file_assetwalletrpc_assetwallet_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrepareAnchoringTemplateRequest.ProtoReflect.Descriptor instead.
func (*PrepareAnchoringTemplateRequest) Descriptor() ([]byte, []int) {
	return file_assetwalletrpc_assetwallet_proto_rawDescGZIP(), []int{4}
}

func (x *PrepareAnchoringTemplateRequest) GetVirtualPsbt() []byte {
	if x != nil {
		return x.VirtualPsbt
	}
	return nil
}

func (x *PrepareAnchoringTemplateRequest) GetOutputAmt() int64 {
	if x != nil {
		return x.OutputAmt
	}
	return 0
...
type PrepareAnchoringTemplateResponse struct {
	...
	// The serialized Bitcoin PSBT for anchoring.
	AnchorPsbt []byte `protobuf:"bytes,1,opt,name=anchor_psbt,json=anchorPsbt,proto3" json:"anchor_psbt,omitempty"`
}

func (x *PrepareAnchoringTemplateResponse) Reset() {
	*x = PrepareAnchoringTemplateResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PrepareAnchoringTemplateResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrepareAnchoringTemplateResponse) ProtoMessage() {}

func (x *PrepareAnchoringTemplateResponse) ProtoReflect() protoreflect.Message {
	mi := &file_assetwalletrpc_assetwallet_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrepareAnchoringTemplateResponse.ProtoReflect.Descriptor instead.
func (*PrepareAnchoringTemplateResponse) Descriptor() ([]byte, []int) {
	return file_assetwalletrpc_assetwallet_proto_rawDescGZIP(), []int{5}
}

func (x *PrepareAnchoringTemplateResponse) GetAnchorPsbt() []byte {
	if x != nil {
		return x.AnchorPsbt
	}
	return nil
...
type UpdateVirtualPsbtRequest struct {
	...
	VirtualPsbt []byte `protobuf:"bytes,1,opt,name=virtual_psbt,json=virtualPsbt,proto3" json:"virtual_psbt,omitempty"` // The serialized virtual PSBT to update.
	ScriptKey   []byte `protobuf:"bytes,2,opt,name=script_key,json=scriptKey,proto3" json:"script_key,omitempty"`       // The new script key for the output.
	AnchorPsbt  []byte `protobuf:"bytes,3,opt,name=anchor_psbt,json=anchorPsbt,proto3" json:"anchor_psbt,omitempty"`    // Optional: The linked Bitcoin PSBT.
}

func (x *UpdateVirtualPsbtRequest) Reset() {
	*x = UpdateVirtualPsbtRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateVirtualPsbtRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateVirtualPsbtRequest) ProtoMessage() {}

func (x *UpdateVirtualPsbtRequest) ProtoReflect() protoreflect.Message {
	mi := &file_assetwalletrpc_assetwallet_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateVirtualPsbtRequest.ProtoReflect.Descriptor instead.
func (*UpdateVirtualPsbtRequest) Descriptor() ([]byte, []int) {
	return file_assetwalletrpc_assetwallet_proto_rawDescGZIP(), []int{6}
}

func (x *UpdateVirtualPsbtRequest) GetVirtualPsbt() []byte {
	if x != nil {
		return x.VirtualPsbt
	}
	return nil
...
func (x *UpdateVirtualPsbtRequest) GetScriptKey() []byte {
	if x != nil {
		return x.ScriptKey
	}
	return nil
...
func (x *UpdateVirtualPsbtRequest) GetAnchorPsbt() []byte {
	if x != nil {
		return x.AnchorPsbt
	}
	return nil
...
type UpdateVirtualPsbtResponse struct {
	...
	UpdatedVirtualPsbt []byte `protobuf:"bytes,1,opt,name=updated_virtual_psbt,json=updatedVirtualPsbt,proto3" json:"updated_virtual_psbt,omitempty"` // The updated serialized virtual PSBT.
	UpdatedAnchorPsbt  []byte `protobuf:"bytes,2,opt,name=updated_anchor_psbt,json=updatedAnchorPsbt,proto3" json:"updated_anchor_psbt,omitempty"`    // Optional: The updated Bitcoin PSBT, if provided.
}

func (x *UpdateVirtualPsbtResponse) Reset() {
	*x = UpdateVirtualPsbtResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateVirtualPsbtResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateVirtualPsbtResponse) ProtoMessage() {}

func (x *UpdateVirtualPsbtResponse) ProtoReflect() protoreflect.Message {
	mi := &file_assetwalletrpc_assetwallet_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateVirtualPsbtResponse.ProtoReflect.Descriptor instead.
func (*UpdateVirtualPsbtResponse) Descriptor() ([]byte, []int) {
	return file_assetwalletrpc_assetwallet_proto_rawDescGZIP(), []int{7}
}

func (x *UpdateVirtualPsbtResponse) GetUpdatedVirtualPsbt() []byte {
	if x != nil {
		return x.UpdatedVirtualPsbt
	}
	return nil
}

func (x *UpdateVirtualPsbtResponse) GetUpdatedAnchorPsbt() []byte {
	if x != nil {
		return x.UpdatedAnchorPsbt
	}
	return nil
}
...
var file_assetwalletrpc_assetwallet_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe4, 0x01, 0x0a, 0x16, 0x46, 0x75, 0x6e, 0x64,
	...
	0x65, 0x48, 0x00, 0x52, 0x03, 0x72, 0x61, 0x77, 0x12, 0x2e, 0x0a, 0x06, 0x69, 0x6e, 0x70, 0x75,
	0x74, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x61, 0x73, 0x73, 0x65, 0x74,
	0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x50, 0x72, 0x65, 0x76, 0x49, 0x64,
	0x52, 0x06, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x12, 0x48, 0x0a, 0x10, 0x63, 0x6f, 0x69, 0x6e,
	0x5f, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01,
	...
	0x65, 0x41, 0x73, 0x73, 0x65, 0x74, 0x50, 0x73, 0x62, 0x74, 0x73, 0x22, 0xc5, 0x02, 0x0a, 0x24,
	0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x61, 0x63, 0x74, 0x69, 0x76,
	0x65, 0x53, 0x65, 0x6e, 0x64, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71,
	...
	0x49, 0x64, 0x53, 0x74, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1b, 0x0a,
	0x09, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04,
	...
	,
	...
	0x52, 0x08, 0x6f, 0x75, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x63,
	0x72, 0x69, 0x70, 0x74, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09,
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x4b, 0x65, 0x79, 0x22, 0x39, 0x0a, 0x16, 0x53, 0x69, 0x67,
	...
	0x50, 0x73, 0x62, 0x74, 0x22, 0x5f, 0x0a, 0x17, 0x53, 0x69, 0x67, 0x6e, 0x56, 0x69, 0x72, 0x74,
	...
	0x6e, 0x70, 0x75, 0x74, 0x73, 0x22, 0x40, 0x0a, 0x19, 0x41, 0x6e, 0x63, 0x68, 0x6f, 0x72, 0x56,
	0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x50, 0x73, 0x62, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x23, 0x0a, 0x0d, 0x76, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x5f, 0x70, 0x73,
	0x62, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x0c, 0x76, 0x69, 0x72, 0x74, 0x75,
	0x61, 0x6c, 0x50, 0x73, 0x62, 0x74, 0x73, 0x22, 0xc4, 0x02, 0x0a, 0x19, 0x43, 0x6f, 0x6d, 0x6d,
	...
	,
	...
	0x69, 0x6c, 0x79, 0x22, 0x53, 0x0a, 0x17, 0x4e, 0x65, 0x78, 0x74, 0x49, 0x6e, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x6c, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x38,
	0x0a, 0x0c, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x74, 0x61, 0x70, 0x72, 0x70, 0x63, 0x2e, 0x4b, 0x65,
	0x79, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x6f, 0x72, 0x52, 0x0b, 0x69, 0x6e, 0x74,
	0x65, 0x72, 0x6e, 0x61, 0x6c, 0x4b, 0x65, 0x79, 0x22, 0x35, 0x0a, 0x14, 0x4e, 0x65, 0x78, 0x74,
	...
	0x49, 0x0a, 0x15, 0x4e, 0x65, 0x78, 0x74, 0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x4b, 0x65, 0x79,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x30, 0x0a, 0x0a, 0x73, 0x63, 0x72, 0x69,
	...
	,
	...
	0x09, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x4b, 0x65, 0x79, 0x12, 0x2c, 0x0a, 0x08, 0x6f, 0x75,
	0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x74,
	0x61, 0x70, 0x72, 0x70, 0x63, 0x2e, 0x4f, 0x75, 0x74, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x08,
	0x6f, 0x75, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x68, 0x61, 0x6c,
	0x6c, 0x65, 0x6e, 0x67, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x63, 0x68, 0x61,
	0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x22, 0x4b, 0x0a, 0x1b, 0x50, 0x72, 0x6f, 0x76, 0x65, 0x41,
	...
	0x65, 0x73, 0x73, 0x22, 0x69, 0x0a, 0x1b, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x41, 0x73, 0x73,
	...
	0x01, 0x28, 0x0c, 0x52, 0x09, 0x63, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x22, 0xf8,
	0x01, 0x0a, 0x1c, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x41, 0x73, 0x73, 0x65, 0x74, 0x4f, 0x77,
	...
	0x12, 0x2c, 0x0a, 0x08, 0x6f, 0x75, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x10, 0x2e, 0x74, 0x61, 0x70, 0x72, 0x70, 0x63, 0x2e, 0x4f, 0x75, 0x74, 0x50,
	0x6f, 0x69, 0x6e, 0x74, 0x52, 0x08, 0x6f, 0x75, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x21,
	0x0a, 0x0c, 0x6f, 0x75, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x5f, 0x73, 0x74, 0x72, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x6f, 0x75, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x53, 0x74,
	...
	0x12, 0x24, 0x0a, 0x0e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x5f, 0x73,
	0x74, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x48,
	0x61, 0x73, 0x68, 0x53, 0x74, 0x72, 0x12, 0x21, 0x0a, 0x0c, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f,
	0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x62, 0x6c,
	0x6f, 0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0x46, 0x0a, 0x16, 0x52, 0x65, 0x6d,
	0x6f, 0x76, 0x65, 0x55, 0x54, 0x58, 0x4f, 0x4c, 0x65, 0x61, 0x73, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x2c, 0x0a, 0x08, 0x6f, 0x75, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18,
	...
	0x74, 0x22, 0x19, 0x0a, 0x17, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x55, 0x54, 0x58, 0x4f, 0x4c,
	0x65, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x4b, 0x0a, 0x17,
	0x44, 0x65, 0x63, 0x6c, 0x61, 0x72, 0x65, 0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x4b, 0x65, 0x79,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x30, 0x0a, 0x0a, 0x73, 0x63, 0x72, 0x69, 0x70,
	...
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x4b, 0x65, 0x79, 0x22, 0x4c, 0x0a, 0x18, 0x44, 0x65, 0x63,
	0x6c, 0x61, 0x72, 0x65, 0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x73,
	...
	,
	...
	0x6e, 0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x50, 0x73, 0x62, 0x74, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5a, 0x0a, 0x12, 0x41, 0x6e, 0x63, 0x68, 0x6f, 0x72, 0x56, 0x69,
	0x72, 0x74, 0x75, 0x61, 0x6c, 0x50, 0x73, 0x62, 0x74, 0x73, 0x12, 0x29, 0x2e, 0x61, 0x73, 0x73,
	0x65, 0x74, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x41, 0x6e, 0x63, 0x68,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_assetwalletrpc_assetwallet_proto_goTypes = []interface{}{
	...
	(*CreateInteractiveSendTemplateRequest)(nil),  // 3: assetwalletrpc.CreateInteractiveSendTemplateRequest
	(*CreateInteractiveSendTemplateResponse)(nil), // 4: assetwalletrpc.CreateInteractiveSendTemplateResponse
	(*PrepareAnchoringTemplateRequest)(nil),       // 5: assetwalletrpc.PrepareAnchoringTemplateRequest
	(*PrepareAnchoringTemplateResponse)(nil),      // 6: assetwalletrpc.PrepareAnchoringTemplateResponse
	(*UpdateVirtualPsbtRequest)(nil),              // 7: assetwalletrpc.UpdateVirtualPsbtRequest
	(*UpdateVirtualPsbtResponse)(nil),             // 8: assetwalletrpc.UpdateVirtualPsbtResponse
	(*TxTemplate)(nil),                            // 9: assetwalletrpc.TxTemplate
	(*PrevId)(nil),                                // 10: assetwalletrpc.PrevId
	(*SignVirtualPsbtRequest)(nil),                // 11: assetwalletrpc.SignVirtualPsbtRequest
	(*SignVirtualPsbtResponse)(nil),               // 12: assetwalletrpc.SignVirtualPsbtResponse
	(*AnchorVirtualPsbtsRequest)(nil),             // 13: assetwalletrpc.AnchorVirtualPsbtsRequest
	(*CommitVirtualPsbtsRequest)(nil),             // 14: assetwalletrpc.CommitVirtualPsbtsRequest
	(*CommitVirtualPsbtsResponse)(nil),            // 15: assetwalletrpc.CommitVirtualPsbtsResponse
	(*PublishAndLogRequest)(nil),                  // 16: assetwalletrpc.PublishAndLogRequest
	(*NextInternalKeyRequest)(nil),                // 17: assetwalletrpc.NextInternalKeyRequest
	(*NextInternalKeyResponse)(nil),               // 18: assetwalletrpc.NextInternalKeyResponse
	(*NextScriptKeyRequest)(nil),                  // 19: assetwalletrpc.NextScriptKeyRequest
	(*NextScriptKeyResponse)(nil),                 // 20: assetwalletrpc.NextScriptKeyResponse
	(*QueryInternalKeyRequest)(nil),               // 21: assetwalletrpc.QueryInternalKeyRequest
	(*QueryInternalKeyResponse)(nil),              // 22: assetwalletrpc.QueryInternalKeyResponse
	(*QueryScriptKeyRequest)(nil),                 // 23: assetwalletrpc.QueryScriptKeyRequest
	(*QueryScriptKeyResponse)(nil),                // 24: assetwalletrpc.QueryScriptKeyResponse
	(*ProveAssetOwnershipRequest)(nil),            // 25: assetwalletrpc.ProveAssetOwnershipRequest
	(*ProveAssetOwnershipResponse)(nil),           // 26: assetwalletrpc.ProveAssetOwnershipResponse
	(*VerifyAssetOwnershipRequest)(nil),           // 27: assetwalletrpc.VerifyAssetOwnershipRequest
	(*VerifyAssetOwnershipResponse)(nil),          // 28: assetwalletrpc.VerifyAssetOwnershipResponse
	(*RemoveUTXOLeaseRequest)(nil),                // 29: assetwalletrpc.RemoveUTXOLeaseRequest
	(*RemoveUTXOLeaseResponse)(nil),               // 30: assetwalletrpc.RemoveUTXOLeaseResponse
	(*DeclareScriptKeyRequest)(nil),               // 31: assetwalletrpc.DeclareScriptKeyRequest
	(*DeclareScriptKeyResponse)(nil),              // 32: assetwalletrpc.DeclareScriptKeyResponse
...
var file_assetwalletrpc_assetwallet_proto_depIdxs = []int32{
	9,  // 0: assetwalletrpc.FundVirtualPsbtRequest.raw:type_name -> assetwalletrpc.TxTemplate
	10, // 1: assetwalletrpc.FundVirtualPsbtRequest.inputs:type_name -> assetwalletrpc.PrevId
	0,  // 2: assetwalletrpc.FundVirtualPsbtRequest.coin_select_type:type_name -> assetwalletrpc.CoinSelectType
	10, // 3: assetwalletrpc.TxTemplate.inputs:type_name -> assetwalletrpc.PrevId
	33, // 4: assetwalletrpc.TxTemplate.recipients:type_name -> assetwalletrpc.TxTemplate.RecipientsEntry
	...
	3,  // 17: assetwalletrpc.AssetWallet.CreateInteractiveSendTemplate:input_type -> assetwalletrpc.CreateInteractiveSendTemplateRequest
	5,  // 18: assetwalletrpc.AssetWallet.PrepareAnchoringTemplate:input_type -> assetwalletrpc.PrepareAnchoringTemplateRequest
	7,  // 19: assetwalletrpc.AssetWallet.UpdateVirtualPsbt:input_type -> assetwalletrpc.UpdateVirtualPsbtRequest
	1,  // 20: assetwalletrpc.AssetWallet.FundVirtualPsbt:input_type -> assetwalletrpc.FundVirtualPsbtRequest
	11, // 21: assetwalletrpc.AssetWallet.SignVirtualPsbt:input_type -> assetwalletrpc.SignVirtualPsbtRequest
	13, // 22: assetwalletrpc.AssetWallet.AnchorVirtualPsbts:input_type -> assetwalletrpc.AnchorVirtualPsbtsRequest
	14, // 23: assetwalletrpc.AssetWallet.CommitVirtualPsbts:input_type -> assetwalletrpc.CommitVirtualPsbtsRequest
	16, // 24: assetwalletrpc.AssetWallet.PublishAndLogTransfer:input_type -> assetwalletrpc.PublishAndLogRequest
	17, // 25: assetwalletrpc.AssetWallet.NextInternalKey:input_type -> assetwalletrpc.NextInternalKeyRequest
	19, // 26: assetwalletrpc.AssetWallet.NextScriptKey:input_type -> assetwalletrpc.NextScriptKeyRequest
	21, // 27: assetwalletrpc.AssetWallet.QueryInternalKey:input_type -> assetwalletrpc.QueryInternalKeyRequest
	23, // 28: assetwalletrpc.AssetWallet.QueryScriptKey:input_type -> assetwalletrpc.QueryScriptKeyRequest
	25, // 29: assetwalletrpc.AssetWallet.ProveAssetOwnership:input_type -> assetwalletrpc.ProveAssetOwnershipRequest
	27, // 30: assetwalletrpc.AssetWallet.VerifyAssetOwnership:input_type -> assetwalletrpc.VerifyAssetOwnershipRequest
	29, // 31: assetwalletrpc.AssetWallet.RemoveUTXOLease:input_type -> assetwalletrpc.RemoveUTXOLeaseRequest
	31, // 32: assetwalletrpc.AssetWallet.DeclareScriptKey:input_type -> assetwalletrpc.DeclareScriptKeyRequest
	4,  // 33: assetwalletrpc.AssetWallet.CreateInteractiveSendTemplate:output_type -> assetwalletrpc.CreateInteractiveSendTemplateResponse
	6,  // 34: assetwalletrpc.AssetWallet.PrepareAnchoringTemplate:output_type -> assetwalletrpc.PrepareAnchoringTemplateResponse
	8,  // 35: assetwalletrpc.AssetWallet.UpdateVirtualPsbt:output_type -> assetwalletrpc.UpdateVirtualPsbtResponse
	2,  // 36: assetwalletrpc.AssetWallet.FundVirtualPsbt:output_type -> assetwalletrpc.FundVirtualPsbtResponse
	12, // 37: assetwalletrpc.AssetWallet.SignVirtualPsbt:output_type -> assetwalletrpc.SignVirtualPsbtResponse
	37, // 38: assetwalletrpc.AssetWallet.AnchorVirtualPsbts:output_type -> taprpc.SendAssetResponse
	15, // 39: assetwalletrpc.AssetWallet.CommitVirtualPsbts:output_type -> assetwalletrpc.CommitVirtualPsbtsResponse
	37, // 40: assetwalletrpc.AssetWallet.PublishAndLogTransfer:output_type -> taprpc.SendAssetResponse
	18, // 41: assetwalletrpc.AssetWallet.NextInternalKey:output_type -> assetwalletrpc.NextInternalKeyResponse
	20, // 42: assetwalletrpc.AssetWallet.NextScriptKey:output_type -> assetwalletrpc.NextScriptKeyResponse
	22, // 43: assetwalletrpc.AssetWallet.QueryInternalKey:output_type -> assetwalletrpc.QueryInternalKeyResponse
	24, // 44: assetwalletrpc.AssetWallet.QueryScriptKey:output_type -> assetwalletrpc.QueryScriptKeyResponse
	26, // 45: assetwalletrpc.AssetWallet.ProveAssetOwnership:output_type -> assetwalletrpc.ProveAssetOwnershipResponse
	28, // 46: assetwalletrpc.AssetWallet.VerifyAssetOwnership:output_type -> assetwalletrpc.VerifyAssetOwnershipResponse
	30, // 47: assetwalletrpc.AssetWallet.RemoveUTXOLease:output_type -> assetwalletrpc.RemoveUTXOLeaseResponse
	32, // 48: assetwalletrpc.AssetWallet.DeclareScriptKey:output_type -> assetwalletrpc.DeclareScriptKeyResponse
...
func file_assetwalletrpc_assetwallet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_assetwalletrpc_assetwallet_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateInteractiveSendTemplateRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_assetwalletrpc_assetwallet_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateInteractiveSendTemplateResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_assetwalletrpc_assetwallet_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PrepareAnchoringTemplateRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_assetwalletrpc_assetwallet_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PrepareAnchoringTemplateResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_assetwalletrpc_assetwallet_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateVirtualPsbtRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_assetwalletrpc_assetwallet_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateVirtualPsbtResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_assetwalletrpc_assetwallet_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
		...
		file_assetwalletrpc_assetwallet_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
		...
		file_assetwalletrpc_assetwallet_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
		...
		file_assetwalletrpc_assetwallet_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
		...
		file_assetwalletrpc_assetwallet_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
		...
		file_assetwalletrpc_assetwallet_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
		...
		file_assetwalletrpc_assetwallet_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
		...
		file_assetwalletrpc_assetwallet_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
	...
	file_assetwalletrpc_assetwallet_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*CreateInteractiveSendTemplateRequest_AssetId)(nil),
		(*CreateInteractiveSendTemplateRequest_AssetIdStr)(nil),
	}
	file_assetwalletrpc_assetwallet_proto_msgTypes[13].OneofWrappers = []interface{}{
